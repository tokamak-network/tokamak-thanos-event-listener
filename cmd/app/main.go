...
func startListener(ctx *cli.Context) error {
	...
	config := &thanosnotif.Config{
		...
		L2Rpc:                  ctx.String(flags.L2RpcUrFlagName),
		L2WsRpc:                ctx.String(flags.L2WsRpcUrFlagName),
		L1StandBridge:          ctx.String(flags.L1StandardBridgeFlagName),
		L2StandBridge:          ctx.String(flags.L2StandardBridgeFlagName),
		...
		L2ToL1MessagePasser:    ctx.String(flags.L2ToL1MessengerParserFlagName),
